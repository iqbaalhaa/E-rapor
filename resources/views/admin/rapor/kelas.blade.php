...
<body>
    @foreach($data as $d)
        ...
        <table class="no-border">
            <tr>
                <td>Nama Peserta Didik</td><td>: {{ $d['siswa']->nama }}</td>
                <td>Kelas</td><td>: {{ $d['kelas']->nama_kelas }}</td>
            </tr>
            <tr>
                <td>NIS/NISN</td><td>: {{ $d['siswa']->nis }}/{{ $d['siswa']->nisn }}</td>
                <td>Fase</td><td>: D</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>Tahun Pelajaran</td><td>: {{ $d['tahun']->tahun }}</td>
            </tr>
        </table>
        ...
        <p style="border:1px solid #000; padding:6px;">
            Ananda {{ $d['siswa']->nama }}, kedisiplinan dan prestasi belajarmu menunjukkan pencapaian yang positif...
        </p>
